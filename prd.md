# GoldGuard AI - Product Requirements Document (PRD)
...
**GoldGuard AI** is the first autonomous trading bot on Base that protects users from inflation by intelligently trading between USDC and tokenized gold, powered by AI decision-making and x402 micropayments.
...
### 2.1 What is GoldGuard AI?

GoldGuard AI is a mobile-first DeFi application that runs as a Base Mini App inside Coinbase Wallet. It uses artificial intelligence to automatically trade between USDC (stablecoin) and tokenized gold (XAU) to protect users' purchasing power from inflation.
...
Unlike traditional trading bots with monthly subscriptions, GoldGuard uses x402 protocol to charge users only when they:
...
| Competitor | Strength | Weakness | GoldGuard Advantage |
|------------|----------|----------|---------------------|
...
"For crypto users concerned about inflation, GoldGuard AI is an autonomous trading bot that protects wealth by intelligently hedging into gold. Unlike traditional trading bots with subscription fees, GoldGuard uses AI and micropayments to provide affordable, personalized inflation protection."
...
- Call `GoldGuardVault.deposit(amount)`
...
3. Show trade preview:
   ...
   - Gas fee: ~$0.02
4. User confirms
5. Call GoldGuardVault.executeTrade()
...
#### Base URL
```
Production: https://api.goldguard.ai
Staging: https://api-staging.goldguard.ai
...
2. Discovers GoldGuard in Base Apps section
3. Taps to open app
4. Sees landing page:
   - Value proposition
...
| Loss of API access (Groq) | High | Low | Multi-LLM support, own hosting option |
...
5. **Content Marketing:**
   - Blog: "How GoldGuard Protects You From Inflation"
...
|---------|------|---------|--------|
| 1.0 | Jan 28, 2026 | Initial PRD | GoldGuard Team |
